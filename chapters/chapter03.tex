...
By propagating a full distribution of representative states through the nonlinear process, the effects of nonlinearity are better captured in the filter. The predicted mean and covariance are computed soley from the set of propgated sigma points. 
\begin{equation}
