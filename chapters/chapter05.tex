...
A modular, low-cost linear actuator set was designed to replace previous iterations found on the SADS that suffered from an insufficient center of mass envelope, unreliable torque output, and maintenance challenges. The resulting system has consistent, high-torque acutation through stepper motors, reduced-friction components, modular sliding mass to rapidly reconfigure the center-of-mass envelope, and full integration with the SADS structure. 
