...
\Cref{chap:background} provides a historical overview of mass balancing systems and a survey of the hardware and algorithms used on contemporary designs. It additionally describes a detailed history of the SADS and the evolution of its own mass balancing system. The thesis objectives are then formally stated. \Cref{chap:methodology} introduces the theoretical framework and conventions used to solve the balancing problem and the details of its practical implementation on the SADS.~\Cref{chap:results} discusses the results of the newly designed system in simulation and experiment and characterizes the achieved balancing results.
